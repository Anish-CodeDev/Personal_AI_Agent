...
from spam_not_spam_model import setup,load_model,classify
import requests
from file_upload import get_file_path
import tkinter as tk
from tkinter import filedialog
load_dotenv()
glove_embedding,tokenizer,vocab = setup()
transformer = load_model(glove_embedding,vocab)
smtp_server = "smtp.gmail.com"
port = 587
context = ssl.create_default_context()
email_id = '' # Within the quotes enter your email address
password = '' # Within the quotes enter your password
approval = True
...
tools = [send_email,read_emails,move_emails_to_spam,respond_to_emails,query_rag,upload_file]
